...
const COPY = {
    privacy: {
        ...
        body: [
            ...
            ["Your rights", "You can request access, correction, or deletion of your personal data at any time by writing to privacy@studioform.app."],
    ...
    terms: {
        ...
        body: [
            ["Acceptance", "By using studioform.app and our products, you agree to these terms. If you don't agree, please don't use the services."],
